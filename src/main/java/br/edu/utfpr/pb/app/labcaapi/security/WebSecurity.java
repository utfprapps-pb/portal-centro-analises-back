...
import br.edu.utfpr.pb.app.labcaapi.security.filters.JWTAuthenticationFilter;
import br.edu.utfpr.pb.app.labcaapi.security.filters.JWTAuthorizationFilter;
...
//                configuration..setAllowedOrigins(List.of("https://ca-dev.app.pb.utfpr.edu.br"));
        ...
        configuration.setAllowedHeaders(List.of("Authorization", "x-xsrf-token", "Origin",
